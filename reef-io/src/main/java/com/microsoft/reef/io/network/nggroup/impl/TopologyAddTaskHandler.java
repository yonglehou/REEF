 ...
 *
 */
public class TopologyAddTaskHandler implements EventHandler<Configuration> {

  private final Topology topology;

  public TopologyAddTaskHandler(final Topology topology) {
    this.topology = topology;
  }

  @Override
  public void onNext(final Configuration partialConf) {
    topology.addTask(taskId(partialConf));
  }
