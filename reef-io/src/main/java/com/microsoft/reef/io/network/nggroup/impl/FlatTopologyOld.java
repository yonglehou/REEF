 ...
 *
 */
public class FlatTopologyOld implements com.microsoft.reef.io.network.nggroup.api.Topology{

  private final TaskGraph taskGraph;
  private OperatorSpec operatorSpec;

  public FlatTopologyOld(
      final EStage<GroupCommMessage> senderStage,
      final Class<? extends Name<String>> groupName,
      final Class<? extends Name<String>> operName, final String driverId) {
    super();
    this.taskGraph = new TaskGraph(senderStage,groupName,operName,driverId);
  }

  @Override
  public void setRoot(final String senderId) {
    taskGraph.setRoot(senderId);
  }
