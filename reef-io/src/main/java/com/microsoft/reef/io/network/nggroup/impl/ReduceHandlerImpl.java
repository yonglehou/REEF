 ...
 *
 */
public class ReduceHandlerImpl implements
    com.microsoft.reef.io.network.nggroup.api.ReduceHandler {

  private static final Logger LOG = Logger.getLogger(ReduceHandlerImpl.class.getName());
